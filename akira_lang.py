translations = {
    ...
    'ru': {
        ...
        'akira_changelog': 'Версия 0.1 pre-alpha — ИК модифицирован, бот запущен впервые. Версия 0.2-alpha — ИК модифицирован x2, добавлена y2v функция (ПРЕ-АЛЬФА), баг фикс. Версия 0.3-beta — бот запущен на Heroku, комманды начинаются не с \"<<.>>, а с <</>>\" ', 
        ...
        'akira_help':
            ...
            '.y2v - Скачать видео с YouTube (АЛЬФА)\n'
